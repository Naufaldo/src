...
//step
char a_gerak[]  ={'d','x','A','w','s','s','x','A','A','x','D','a','x','w','A','s','d','A','w','A','D','d','w','s','s','x','a','w','A','x','s','d','A','w','A','w','D','w','D','a','A','w','D','w','D','a','w','s','s','x','A','d','D','x','w','D','w','s','a','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {53, {0,170,0,0,-1,-1,-2,0,1,1}},
  {54, {0,170,0,0,-1,-1,-2,0,1,1}}, //ke sz5
