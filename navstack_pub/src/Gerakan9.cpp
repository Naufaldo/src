...
//step
char a_gerak[]  ={'d','x','A','w','s','s','x','A','A','x','D','a','x','w','A','s','d','A','w','A','D','d','w','s','s','x','a','w','A','x','s','d','A','w','A','w','D','w','D','a','A','w','D','w','D','a','w','s','s','x','A','d','D','D','w','s','a','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {0, {200,0,0,500,0.64,-1,-2,0,1,1}},
  {1, {0,0,60,0,-1,-1,-2,0,1,1}},
  {2, {495,230,0,0,-1,-1,-2,0,2,1}}, //keluar home
  {3, {0,0,210,0,-1,-1,0,-1,1,1}}, //ke k1
  {4, {0,100,0,0,-1,-1,0,0,2,1}}, //k1
  ...
  {11, {0,240,480,100,-1,-1,-2,0,1,1}}, //ke sz1
  {12, {0,180,0,0,-1,-1,-2,0,1,1}}, //ke sz1
  {13, {0,240,0,0,-1,-1,-2,0,1,1}},
  {14, {0,0,0,90,-1,-1,-2,0,1,1}},
  {15, {0,150,0,0,-1,-1,0,-1,1,1}}, //sz1
  {16, {400,400,250,200,0.64,-1,-2,0,1,1}}, //arah kelereng
  {17, {0,0,0,200,-1,-1,-2,0,1,1}},
  {18, {0,459,517,0,-1,-1,-2,0,1,1}}, //ke k2
  {19, {0,0,0,70,-1,-1,-2,0,1,1}},
  {20, {0,0,0,70,-1,-1,-2,0,1,1}},
  {21, {0,260,0,280,-0.00,-1,-2,0,1,2}}, //hadap k2
  {22, {0,100,0,0,-1,-1,0,-1,1,1}}, //ke k2
  {23, {0,100,0,0,-1,-1,0,0,1,1}}, //k2
  {24, {0,120,0,0,-1,-1,-2,0,1,1}},
  {25, {0,0,70,0,-1,-1,-2,0,1,1}},
  {26, {0,0,580,50,0.63,-1,-2,0,1,1}}, //arah sz2 //d
  {27, {0,180,0,0,-1,-1,-2,0,1,1}}, //ke sz2 //w
  {28, {0,0,0,50,-1,-1,-2,0,1,1}}, 
  {29, {0,200,0,0,-1,-1,-2,0,1,1}},
  {30, {0,150,0,0,-1,-1,0,-1,1,1}}, //sz2 //s
  {31, {0,400,200,200,-0.02,-1,-2,0,1,1}}, //keluar sz2 //a
  {32, {0,0,0,70,-1,-1,-2,0,1,1}},
  {33, {200,0,750,0,-1,-1,-2,0,1,1}}, //menuju jalan retak
  {34, {0,0,0,100,-1,-1,-2,0,1,1}},
  {35, {0,0,750,0,-1,-1,-2,0,1,1}},
  {36, {120,0,0,370,-1,-1,-2,0,2,1}}, //menuju jalan retak
  {37, {0,180,300,250,-1,-1,-2,0,1,1}}, //melewati jalan retak dan batu
  {38, {160,0,0,0,-1,-1,-2,0,1,1}},
  {39, {150,300,180,400,0.62,-1,-2,0,1,1}}, //posisi siap naik tangga
  {40, {150,0,0,0,-1,-1,-2,0,1,1}},
  {41, {0,140,0,0,-1,-1,-2,0,1,1}}, //posisi siap naik tangga
  {42, {220,0,500,0,-1,-1,-2,0,1,1}}, //naik tangga
  {43, {0,200,0,0,-1,-1,-2,0,1,1}},
  {44, {300,0,140,0,-1,-1,-2,0,1,1}},
  // 'd','w','s','s','x','D','a','A','x','w','A','w','s','d','w','s'
  // 44                                                           59
  {45, {0,0,0,600,0.62,-1,-2,0,1,1}},
  {46, {0,100,0,0,-1,-1,-2,0,1,1}},
  {47, {0,100,0,0,0,-1,-2,0,1,1}}, //hadap k5
  {48, {0,100,0,0,-1,-1,-2,0,1,1}}, //hadap k5
  {49, {0,0,100,0,-1,-1,0,-1,1,1}}, //di k5
  {50, {300,0,400,0,-1,-1,0,0,1,1}}, //di k5
  {51, {0,230,0,100,-0.00,-1,-2,0,1,1}},
  {52, {0,0,0,370,-1,-1,-2,0,1,1}}, //dari k5
  {53, {137,0,300,0,-1,-1,-2,0,1,1}}, //sz5
...
std::map<int, std::vector<bool>> _f_{
  ...
  {51, {0,0,0,1,1,0,1,0,1}},
  {52, {0,0,0,0,0,0,1,0,1}},
  {53, {1,0,1,0,0,0,1,0,1}},
