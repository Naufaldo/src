...
std::map<int, std::vector<int>> step{
  ...
  {0, {320, 320, 320, 50, 50, -2, 0}}, // posisi home gerak ke kanan
  {1, {320, 320, 20, 0, 0, 0, -1}}, // posisi depan K1
  {2, {320, 320, 15, 320, 320, -2, 0}}, // posisi mundur dari K1
  {3, {40,40,0,0,0,-2,0}}, // jalan nyamping ke sz 2
  {4, {30,0,0,0,30,-2,0}}, //putar kanan
  {5, {20,20,320,320,320,0,-1}}, //putar kiri hadep kelereng
...
std::map<int, std::vector<bool>> _f_{
  ...
  {0, {1,1,1,0,0,1,0,0}}, // posisi home gerak ke kanan semua sensor nilai lebih dari batas
  {1, {1,1,0,0,0,1,0,0}},
  {2, {1,1,1,1,1,1,0,0}},
  {3, {1,1,0,0,0,1,0,1}},
  {4, {1,0,0,0,1,1,0,1}},
