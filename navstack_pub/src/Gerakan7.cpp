...
//step
char a_gerak[]  ={'x','A','w','s','s','x','A','A','x','D','a','x','w','A','w','d','A','w','A','D','d','w','s','s','x','a','w','A','x','w','d','A','w','A','w','D','w','D','w','D','a','A','w','D','w','D','a','w','s','s','x','A','d','D','D','w','w','a','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {1, {520,250,0,0,-1,-1,-2,0,2,1}}, //keluar home
  {2, {0,0,190,0,-1,-1,0,-1,1,1}}, //ke k1
  {3, {0,100,0,0,-1,-1,0,0,1,1}}, //k1
  {4, {0,100,0,0,-1,-1,-2,0,1,1}},
  {5, {0,0,80,0,-1,-1,-2,0,1,1}}, //dari k1
  {6, {624,0,0,0,-1,-1,-2,0,2,1}},
  {7, {0,500,0,190,-1,-1,-2,0,1,1}}, //ke jalan retak, miring, batu
  {8, {0,0,50,0,-1,-1,-2,0,1,1}},
  {9, {0,0,0,200,-1,-1,-2,0,1,1}},
  {10, {0,240,480,100,-1,-1,-2,0,1,1}}, //ke sz1
  {11, {0,200,0,0,-1,-1,-2,0,1,1}}, //ke sz1
  {12, {0,200,0,0,-1,-1,-2,0,1,1}},
  {13, {0,0,0,50,-1,-1,-2,0,1,1}},
  {14, {0,180,0,0,-1,-1,0,-1,1,1}}, //sz1
  {15, {400,400,240,200,0.64,-1,-2,0,1,1}}, //arah kelereng
  {16, {0,0,0,100,-1,-1,-2,0,1,1}},
  {17, {0,459,517,0,-1,-1,-2,0,1,1}}, //ke k2
  {18, {0,0,0,70,-1,-1,-2,0,1,1}},
  {19, {0,0,0,70,-1,-1,-2,0,1,1}},
  {20, {0,260,0,280,-0.00,-1,-2,0,1,2}}, //hadap k2
  {21, {0,110,180,0,-1,-1,0,-1,1,1}}, //ke k2
  {22, {0,110,0,0,-1,-1,0,0,1,1}}, //k2
  {23, {0,120,0,0,-1,-1,-2,0,1,1}},
  {24, {0,0,70,0,-1,-1,-2,0,1,1}},
  {25, {0,0,550,50,0.63,-1,-2,0,1,1}}, //arah sz2 //d
  {26, {0,180,0,0,-1,-1,-2,0,1,1}}, //ke sz2 //w
  {27, {0,0,0,50,-1,-1,-2,0,1,1}}, 
  {28, {0,200,0,0,-1,-1,-2,0,1,1}},
  {29, {0,300,0,0,-1,-1,0,-1,1,1}}, //sz2 //s
  {30, {0,400,190,200,-0.1,-1,-2,0,1,1}}, //keluar sz2 //a
  {31, {0,0,0,60,-1,-1,-2,0,1,1}},
  {32, {200,0,750,0,-1,-1,-2,0,1,1}}, //menuju jalan retak
  {33, {0,0,0,60,-1,-1,-2,0,1,1}},
  {34, {0,0,810,0,-1,-1,-2,0,1,1}},
  {35, {120,0,0,370,-1,-1,-2,0,2,1}}, //menuju jalan retak
  {36, {0,300,0,0,-1,0.1,-2,0,1,1}},
  {37, {130,0,0,0,-1,-1,-2,0,1,1}},
  {38, {0,180,300,250,-1,0.1,-2,0,1,1}}, //melewati jalan retak dan batu
  {39, {160,0,0,0,-1,-1,-2,0,1,1}},
  {40, {150,300,180,400,0.62,-1,-2,0,1,1}}, //posisi siap naik tangga
  {41, {150,0,0,0,-1,-1,-2,0,1,1}},
  {42, {0,140,0,0,-1,-1,-2,0,1,1}}, //posisi siap naik tangga
  {43, {0,0,540,0,-1,-1,-2,0,1,1}}, //naik tangga
  {44, {0,200,0,0,-1,-1,-2,0,1,1}},
  {45, {70,0,200,0,-1,-1,-2,0,1,1}},
  // 'd','w','s','s','x','D','a','A','x','w','A','w','s','d','w','s'
  // 44                                                           59
  {46, {0,0,0,600,0.62,-1,-2,0,1,1}},
  {47, {0,120,190,0,-1,-1,0,-1,1,1}},
  {48, {0,120,0,0,0,-1,0,0,1,1}}, //hadap k5
  {49, {0,100,0,0,-1,-1,-2,0,1,1}}, //hadap k5
  {50, {0,0,100,0,-1,-1,-2,0,1,1}}, //di k5
  {51, {340,0,400,0,-1,-1,-2,0,1,1}}, //di k5
  {52, {0,350,0,180,-0.00,-1,-2,0,1,1}},
  {53, {0,0,0,370,-1,-1,-2,0,1,1}}, //dari k5
  {54, {137,0,300,0,-1,-1,-2,0,1,1}}, //sz5
  {55, {0,0,250,0,-1,-1,-2,0,1,1}},
  {56, {0,200,0,0,-1,-1,0,-1,1,1}},
  {57, {400,200,0,200,-1,-1,-2,0,1,1}}, //arah finish
...
std::map<int, std::vector<bool>> _f_{
  ...
  {43, {1,0,0,0,0,0,1,0,1}},
  {44, {0,1,0,0,0,0,1,0,1}},
  {45, {1,0,1,0,0,0,1,0,1}},
  //'d','w','s','s','x','D','a','A','x','w','A','w','s','d','w','s'
  ...
  {52, {0,1,0,1,1,0,1,0,1}},
  {53, {0,0,0,0,0,0,1,0,1}},
  {54, {1,0,1,0,0,0,1,0,1}},
  {55, {0,0,0,0,0,0,1,0,1}},
  {56, {0,1,0,0,0,0,1,0,1}},
  {57, {0,1,0,1,0,0,1,0,1}},
