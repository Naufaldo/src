...
//step
char a_gerak[]  ={'x','A','w','s','s','x','A','A','x','D','a','x','w','A','w','d','A','w','A','D','d','w','s','s','x','a','w','A','x','w','d','A','w','A','w','D','w','D','w','D','a','A','w','D','w','D','a','w','s','s','x','A','d','D','D','w','w','x','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {57, {0,0,200,0,-1,-1,0,-1,1,1}}, //arah finish
