...
//step
char a_gerak[]  ={'x','A','w','s','s','x','A','A','x','D','a','x','w','A','s','d','A','w','A','D','d','w','s','s','x','a','w','A','x','s','d','A','w','A','w','D','w','D','a','A','w','D','w','D','A','w','d','A','w','s','s','x','D','D','w','s','a','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {13, {0,0,0,90,-1,-1,-2,0,1,1}},
  {14, {0,150,0,0,-1,-1,0,-1,1,1}}, //sz1
  {15, {400,400,250,200,0.64,-1,-2,0,1,1}}, //arah kelereng
  {16, {0,0,0,200,-1,-1,-2,0,1,1}},
  ...
  {30, {0,400,200,200,-0.02,-1,-2,0,1,1}}, //keluar sz2 //a
  {31, {0,0,0,70,-1,-1,-2,0,1,1}},
  {32, {200,0,750,0,-1,-1,-2,0,1,1}}, //menuju jalan retak
  {33, {0,0,0,100,-1,-1,-2,0,1,1}},
  {34, {0,0,750,0,-1,-1,-2,0,1,1}},
  {35, {120,0,0,370,-1,-1,-2,0,2,1}}, //menuju jalan retak
  {36, {0,180,300,250,-1,-1,-2,0,1,1}}, //melewati jalan retak dan batu
  {37, {190,0,0,0,-1,-1,-2,0,1,1}},
  {38, {150,300,180,400,0.62,-1,-2,0,1,1}}, //posisi siap naik tangga
  {39, {150,0,0,0,-1,-1,-2,0,1,1}},
  {40, {0,140,0,0,-1,-1,-2,0,1,1}}, //posisi siap naik tangga
  {41, {220,0,500,0,-1,-1,-2,0,1,1}}, //naik tangga
  {42, {0,200,0,0,-1,-1,-2,0,1,1}},
  {43, {300,0,140,0,-1,-1,-2,0,1,1}},
  {44, {220,0,0,0,-1,-1,-2,0,1,1}},
  {45, {0,100,0,0,-1,-1,-2,0,1,1}},
  {46, {0,230,0,100,0.00,-1,-2,0,1,1}}, //hadap k5
  {47, {0,0,0,100,-1,-1,-2,0,1,1}}, //hadap k5
  {48, {0,100,0,0,-1,-1,0,-1,1,1}}, //di k5
  {49, {0,100,0,0,-1,-1,0,0,1,1}}, //di k5
  {50, {0,110,0,0,-1,-1,-2,0,1,1}},
  {51, {0,300,0,0,-1,-1,-2,0,1,1}}, //dari k5
  {52, {500,700,700,300,-1,-1,-2,0,1,1}},
  {53, {100,400,0,0,-1,-1,-2,0,1,1}}, //ke sz5
  {54, {250,0,0,0,-1,-1,-2,0,1,1}}, //sz5
  {55, {0,200,0,0,-1,-1,0,-1,1,1}},
  {56, {400,200,0,200,-1,-1,-2,0,1,1}}, //arah finish
  {57, {0,100,0,0,-1,-1,-2,0,1,1}}, //finish
...
void kontrol(char arah_, int step_){
  ...
  if (moveBindings.count(key) == 1)
    ...
    head_Tws.linear.x = xb * 0.3125 ; //lifter
