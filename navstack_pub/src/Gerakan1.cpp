...
std::map<int, std::vector<int>> step{
  ...
  {0, {350, 350, 5, 32, 32, -2, 0}}, // posisi home gerak ke kanan
  {1, {350, 350, 5, 32, 57, 0, -1}}, // posisi depan K1
...
std::map<int, std::vector<bool>> _f_{
  ...
  {0, {1,1,0,1,1,1}}, // posisi home gerak ke kanan semua sensor nilai lebih dari batas
  {1, {1,1,0,0,0,1}},
  {2, {0,0,0,0,0,1}},
  {3, {0,0,0,0,0,1}},
  {4, {0,0,0,0,0,1}},
