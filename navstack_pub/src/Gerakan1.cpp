...
//step
char a_gerak[]  ={'a','D', 'w', 's', 'x', 'D','d', 's', 'a', 'w', 'a', 'w', 's', 'd', 'w', 's', 'a', 'w', 'a','w','d','w', 'x', 'A', 'a','d', 'D','x','w','x', 'A','w','A','a','w','d','w','c','A','w','s'};
...
std::map<int, std::vector<int>> step{
  ...
  {0, {0, 0, 0, 0,-2, 0, 2, 2 }}
  {1, {0, 200, 0, 550, -2 ,0,2,2}},
  {2, {0, 160, 220, 0, 0, -1,1,1}},
  {3, {0, 250, 0, 0, 0, 0,1,1}},
  {4, {0, 0, 100, 0, -2, 0,1,1}},
  {5, {200, 800, 0, 300, -2, 0,1,1}},
  {6, {150, 300, 300, 0, -2, 0,2,2}},
  {7, {0, 120, 0, 0, 0, -1,2,2}},
  {8, {300, 0, 200, 0, -2, 0,2,2}},
  {9, {300, 0, 350, 0, -2, 0,1,1}},
  {10, {0,0,340,0,0,-1,2,2}},
  {11, {0,180,0,0,-2,0,2,2}},
  {12, {242,473,423,178,-2,0,2,2}},
  {13, {0,248,0,0,-2,0,2,2}},
  {14, {0,125,0,0,0,-1,2,2}},
  {15, {360,629,195,260,-2,0,2,2}},
  {16, {205,285,370,450,-2,0,2,2}},
  {17, {234,0,275,0,-2,0,2,2}},
  {18, {0,397,368,0,-2,0,2,2}},
  {19, {0,295,166,0,-2,0,2,2}},
  {20, {0,115,190,0,0,-1,2,2}},
  {21, {0,255,168,0,0,-1,2,2}},
  {22, {160,0,0,425,-2,0,2,2}},
  {23, {450,260,352,385,-2,0,2,2}},
  {24, {630, 270,230,300,0,-1,2,2}},
  {25, {340, 90, 0, 710,-2,0,2,2}},
  {26, {0,0,160,0,-2,0,2,2}},
  {27, {0,0,170,0,0,-1,2,2}},
  {28, {0,0,150,0,-2,0,2,2}},
  {29, {290,0,0,150,-2,0,2,2}},
  {30, {0,0,307,0,-2,0,2,2}},
  {31, {0,0,770,390,-2,0,2,2}},
  {32, {220,470,0,750,-2,0,2,2}},
  {33, {0,230,0,0,-2,0,2,2}},
  {34, {235,260,0,0,0,-1,2,2}},
  {35, {0,220,0,0,0,-1,2,2}},
  {36, {180,280,0,550,-2,0,2,2}},
  {37, {660,0,0,190,-2,0,2,2}},
  {38, {0,210,315,0,-2,0,2,2}},
  {39, {0 ,0 ,0 ,0 ,-2,0,2,2}},
  {40, {185,180,325,770,-2,0,2,2}},
};
