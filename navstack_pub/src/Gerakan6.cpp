...
//step
char a_gerak[]  ={'x','D','w','s','s','x','D','x','A','d','x','w','D','s','a','D','w','D','A','a','w','s','s','x','d','w','D','x','s','a','D','w','D','w','A','w','A','d','D','w','A','w','A','d','w','s','s','x','D','a','A','x','w','A','w','s','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {43, {600,0,0,0,-0.85,-1,-2,0,1,1}},
  {44, {0,100,0,0,-1,-1,-2,0,1,1}},
  {45, {0,100,0,0,0,-1,-2,0,1,1}}, //hadap k5
  {46, {0,100,0,0,-1,-1,-2,0,1,1}}, //hadap k5
  {47, {0,0,100,0,-1,-1,0,-1,1,1}}, //di k5
  {48, {0,0,400,300,-1,-1,0,0,1,1}}, //di k5
  {49, {100,230,0,0,-0.3,-1,-2,0,1,1}},
  {50, {370,0,0,0,-1,-1,-2,0,1,1}}, //dari k5
  {51, {0,170,0,0,-1,-1,-2,0,1,1}},
  {52, {0,170,0,0,-1,-1,-2,0,1,1}}, //ke sz5
  {53, {0,0,300,137,-1,-1,-2,0,1,1}}, //sz5
  {54, {0,0,250,0,-1,-1,-2,0,1,1}},
