...
//step
char a_gerak[]  ={'x','D','w','s','s','x','D','x','A','d','x','w','s','a','w','D','A','a','w','s','s','x','d','w','s','a','D','w','A','w','A','d','w','A','A','a','D','w','s','s','x','A','A','w','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {2, {0,200,200,0,-1,-1,0,-1,1,1}}, //ke k1
  {3, {0,200,0,0,-1,-1,0,0,1,1}}, //k1
  {4, {0,200,0,0,-1,-1,-2,0,1,1}},
  ...
  {31, {400,300,200,150,0.80,-1,-2,0,1,1}}, //posisi siap naik tangga
