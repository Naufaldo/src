...
std::map<int, std::vector<float>> step{
  ...
  {3, {0,160,0,0,-1,-1,0,0,2,1}}, //k1
  {4, {0,0,80,0,-1,-1,-2,0,2,1}}, //dari k1
  {5, {200,600,0,0,-1,-1,-2,0,1,1}}, //ke jalan retak, miring, batu
