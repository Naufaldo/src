...
//step
char a_gerak[]  ={'x','D','w','s','s','x','D','x','d','x','w','s','a','w','D','A','a','w','s','s','x','d','w','s','a','D','w','A','w','d','w','A','w','a','D','w','s','s','x','A','A','w','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {1, {0,295,0,490,-1,-1,-2,0,1,1}}, //keluar home
  {2, {0,150,200,0,-1,-1,0,-1,0.5,1}}, //ke k1
  ...
  {8, {0,280,0,400,0.8,-1,-2,0,1,1}}, //ke sz1
  ...
  {16, {350,260,0,0,0.78,-1,-2,0,1,2}}, //hadap k2
  ...
  {24, {200,400,200,0,0.00,0,-2,0,1,1}}, //keluar sz2 //a
  ...
  {32, {0,90,0,0,-1,-1,-2,0,1,1}},
  {33, {160,280,0,570,-1,-1,-2,0,1,1}}, //hadap k5
