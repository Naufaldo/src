...
//step
char a_gerak[]  ={'x','D','w','s','s','x','D','x','d','x','w','s','a','w','D','A','a','w','s','s','x','d','w','s','a','D','w','A','w','d','w','A','A','a','D','w','s','s','x','A','A','w','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {29, {400,300,200,150,0.80,-1,-2,0,1,1}}, //posisi siap naik tangga
  {30, {0,100,0,0,-1,-1,-2,0,1,1}}, //posisi siap naik tangga
  {31, {0,0,600,220,-1,-1,-2,0,1,1}}, //naik tangga
  {32, {0,0,100,120,-1,-1,-2,0,1,1}},
  {33, {180,280,0,470,-1,-1,-2,0,1,1}}, //hadap k5
  {34, {140,0,0,0,-1,-1,-2,0,1,1}}, //hadap k5
  {35, {0,120,0,0,-1,-1,0,-1,1,1}}, //di k5
  {36, {0,120,0,0,-1,-1,0,0,1,1}}, //di k5
  {37, {0,140,0,0,-1,-1,0,0,1,1}},
  {38, {0,300,0,0,-1,-1,-2,0,1,1}}, //dari k5
  {39, {300,700,700,500,-1,-1,-2,0,1,1}},
  {40, {0,400,0,90,-1,-1,-2,0,1,1}}, //ke sz5
  {41, {0,200,0,0,-1,-1,-2,0,1,1}}, //sz5
  {42, {200,200,0,400,-1,-1,0,-1,1,1}}, //arah finish
  {43, {0,100,0,0,-1,-1,-2,0,1,1}}, //finish
  {44, {0,0,0,0,-1,-1,0,-1,1,1}},
};
...
std::map<int, std::vector<bool>> _f_{
  ...
  {40, {0,1,0,1,0,0,1,0,1}},
  {41, {0,1,0,0,0,0,1,0,1}},
  {42, {1,1,0,0,0,0,1,0,1}},
  {43, {0,1,0,0,0,0,1,0,1}},
  {44, {1,1,1,1,0,0,1,0,1}},
};
