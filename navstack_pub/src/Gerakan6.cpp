...
//step
char a_gerak[]  ={'x','D','w','s','s','x','D','x','d','x','w','s','a','w','D','A','a','w','s','x','d','w','s','a','D','w','A','w','d','d','w','A','w','a','D','w','s','s','x','A','w','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {38, (0,700,700,0,0,-1,-1,-2,0,1,1)},
  {39, {0,0,0,90,-1,-1,-2,0,1,1}}, //ke sz5
  {40, {0,200,0,0,-1,-1,-2,0,1,1}}, //sz5
  {41, {200,200,0,400,-1,-1,0,-1,1,1}}, //arah finish
  {42, {0,100,0,0,-1,-1,-2,0,1,1}}, //finish
  {43, {0,0,0,0,-1,-1,-2,0,1,1}},
};
