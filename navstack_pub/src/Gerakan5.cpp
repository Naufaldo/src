...
std::map<int, std::vector<int>> step{
  ...
  {0, {0,0,0,253,0,0,470,0,-2,0,2,1}}, //keluar home
  {1, {0,0,0,117,220,0,0,0,0,-1,1,1}}, //ke k1
  {2, {0,0,0,160,0,0,0,0,0,0,1,1}}, //k1
  {3, {0,0,0,0,77,0,0,0,-2,0,2,1}}, //dari k1
  {4, {0,100,0,700,0,0,0,0,-2,0,1,1}}, //ke jalan retak, miring, batu
  {5, {0,0,400,210,230,0,0,0,-2,0,1,1}}, //ke sz1
  {6, {0,0,0,130,0,0,0,0,0,-1,1,1}}, //sz1
  {7, {0,0,81,700,0,0,0,0,-2,0,1,1}}, //arah kelereng
  {8, {0,0,0,420,545,0,220,0,-2,0,1,1}}, //ke k2
  {9, {0,428,0,195,180,0,335,0,-2,0,1,1}}, //hadap k2
  ...
  // {17, {425,0,0,0,-2,0,1,1}}, //menuju jalan retak
  // {18, {0,150,0,0,-2,0,1,1}}, //melewati jalan retak dan batu
  // {19, {0,300,200,150,-2,0,1,1}}, //posisi siap naik tangga
  // {20, {0,190,0,0,-2,0,1,1}}, //posisi siap naik tangga
  // {21, {0,0,600,220,-2,0,1,1}}, //naik tangga
  // {22, {140,220,0,0,-2,0,1,1}}, //hadap k5
  // {23, {140,100,0,0,0,-1,1,1}}, //hadap k5
  // {24, {0,100,0,0,0,0,1,1}}, //di k5
  // {25, {0,100,0,0,-2,0,1,1}}, //di k5
  // {26, {0,200,0,0,-2,0,1,1}}, //dari k5
  // {27, {0,0,0,350,-2,0,1,1}}, //ke sz5
  // {28, {0,250,0,0,-2,0,1,1}}, //sz5
  // {29, {400,0,0,600,0,-1,1,1}}, //arah finish
  // {30, {0,400,0, 0, 0, -2, 0, 1, 1}}, //finish
  // {31, {0,0,0,0,-2,0,1,1}},
