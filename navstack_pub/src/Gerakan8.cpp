...
//step
char a_gerak[]  ={'a','x','D','w','s','s','x','D','x','A','d','x','w','D','s','a','D','w','D','A','a','w','s','s','x','d','w','D','x','s','a','D','w','D','w','A','w','A','d','D','w','A','w','A','d','w','s','s','x','D','a','A','A','w','s','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {28, {0,200,0,0,-1,-1,-2,0,1,1}},
  {29, {0,150,0,0,-1,-1,0,-1,1,1}}, //sz2 //s
  {30, {200,400,200,0,-0.28,-1,-2,0,1,1}}, //keluar sz2 //a
  {31, {70,0,0,0,-1,-1,-2,0,1,1}},
  {32, {0,0,750,200,-1,-1,-2,0,1,1}}, //menuju jalan retak
  {33, {100,0,0,0,-1,-1,-2,0,1,1}},
  {34, {0,0,750,0,-1,-1,-2,0,1,1}},
  {35, {370,0,0,120,-1,-1,-2,0,2,1}}, //menuju jalan retak
  {36, {250,180,300,0,-1,-1,-2,0,1,1}}, //melewati jalan retak dan batu
  {37, {0,0,0,190,-1,-1,-2,0,1,1}},
  {38, {400,300,180,150,-0.80,-1,-2,0,1,1}}, //posisi siap naik tangga
  {39, {0,0,0,150,-1,-1,-2,0,1,1}},
  {40, {0,140,0,0,-1,-1,-2,0,1,1}}, //posisi siap naik tangga
  {41, {0,0,500,220,-1,-1,-2,0,1,1}}, //naik tangga
  {42, {0,200,0,0,-1,-1,-2,0,1,1}},
  {43, {0,0,140,300,-1,-1,-2,0,1,1}},
  // 'd','w','s','s','x','D','a','A','A','w','s','d','w','s'
  // 44,                                                , 57
  {44, {600,0,0,0,-0.85,-1,-2,0,1,1}},
  {45, {0,100,0,0,-1,-1,-2,0,1,1}},
  {46, {0,100,0,0,0,-1,-2,0,1,1}}, //hadap k5
  {47, {0,100,0,0,-1,-1,-2,0,1,1}}, //hadap k5
  {48, {0,0,100,0,-1,-1,0,-1,1,1}}, //di k5
  {49, {0,0,400,300,-1,-1,0,0,1,1}}, //di k5
  {50, {100,230,0,0,-0.3,-1,-2,0,1,1}},
  {51, {500,0,0,0,-1,-1,-2,0,1,1}}, //dari k5
  {52, {0,0,0,170,-1,-1,-2,0,1,1}}, //sz5
  {53, {0,0,250,0,-1,-1,-2,0,1,1}},
  {54, {0,200,0,0,-1,-1,0,-1,1,1}},
  {55, {200,200,0,400,-1,-1,-2,0,1,1}}, //arah finish
  {56, {0,180,0,0,-1,-1,-2,0,1,1}}, //finish
  {57, {0,0,0,0,-1,-1,0,-1,1,1}},
};
...
std::map<int, std::vector<bool>> _f_{
  ...
  {38, {0,0,1,1,1,0,1,0,1}},
  {39, {0,0,0,0,0,0,1,0,1}},
  {40, {0,1,0,0,0,0,1,0,1}},
  {41, {0,0,0,1,0,0,1,0,1}},
  {42, {0,1,0,0,0,0,1,0,1}},
  {43, {0,0,1,1,0,0,1,0,1}},
  // 'd','w','s','s','x','D','a','A','x','w','A','w','d','w','s'
  {44, {0,0,0,0,1,0,1,0,1}},
  {45, {0,1,0,0,0,0,1,0,1}},
  {46, {0,1,0,0,0,0,1,0,1}},
  {47, {0,0,0,0,0,0,1,0,1}},
  {48, {0,0,1,0,0,0,1,0,1}},
  {49, {0,0,0,0,0,0,1,0,1}},
  {50, {1,0,0,0,0,0,1,0,1}},
  {51, {0,0,0,0,0,0,1,0,1}},
  {52, {0,0,0,1,0,0,1,0,1}},
  {53, {0,0,0,0,0,0,1,0,1}},
  {54, {0,1,0,0,0,0,1,0,1}},
  {55, {1,1,0,0,0,0,1,0,1}},
  {56, {0,1,0,0,0,0,1,0,1}},
  {57, {1,1,1,1,0,0,1,0,1}},
};
