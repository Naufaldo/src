...
//step
char a_gerak[]  ={'a','x','D','w','s','s','x','D','x','A','d','x','w','D','s','a','D','w','D','A','a','w','s','s','x','d','w','D','x','s','a','D','w','D','w','A','w','A','w','A','d','D','w','A','w','A','d','w','s','s','x','D','a','A','A','w','s','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {47, {0,100,200,0,-1,-1,-2,0,1,1}},
  {48, {0,100,0,0,0,-1,-2,0,1,1}}, //hadap k5
  {49, {0,100,0,0,-1,-1,-2,0,1,1}}, //hadap k5
  {50, {0,0,100,0,-1,-1,0,-1,1,1}}, //di k5
  {51, {0,0,400,300,-1,-1,0,0,1,1}}, //di k5
