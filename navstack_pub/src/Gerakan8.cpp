...
//step
char a_gerak[]  ={'a','x','D','w','s','s','x','D','x','A','d','x','w','D','s','a','D','w','D','A','a','w','s','s','x','d','w','D','x','s','a','D','w','D','w','A','w','A','d','D','w','A','w','A','d','w','s','s','x','D','a','A','x','w','A','w','s','d','w','s'}; 
...
std::map<int, std::vector<float>> step{
  ...
  {51, {370,0,0,0,-1,-1,-2,0,1,1}}, //dari k5
  {52, {0,170,0,0,-1,-1,-2,0,1,1}},
  {53, {0,170,0,0,-1,-1,-2,0,1,1}}, //ke sz5
  {54, {0,0,300,137,-1,-1,-2,0,1,1}}, //sz5
