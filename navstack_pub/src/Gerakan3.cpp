...
//step
char a_gerak[]  ={'D','w','s','x','D','d','s','a','w','a','w','s','d','w','s','a','w',
                  'a','w','d','w', 'x', 'A', 'a','d', 'D','x','w','x', 'A','w','A','a','w','d','w','c','A','w','s'}; // untuk diupdate
};
...
std::map<int, std::vector<int>> step{
  ...
  {10, {0,180,0, 0,0,-1,2,2}}, //ke k2
  {11, {0, 180, 0, 0, 0, -1, 2, 2 }}, //k2
